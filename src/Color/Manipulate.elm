...
-}
scaleHsl : { saturationScale : Float, lightnessScale : Float, alphaScale : Float } -> Color -> Color
...
-}
scaleRgb : { redScale : Float, greenScale : Float, blueScale : Float, alphaScale : Float } -> Color -> Color
